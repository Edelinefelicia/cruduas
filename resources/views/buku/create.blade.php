    ...
    <div class="container">
        ...
        <form method="post" action="{{ route('buku.store') }}" enctype="multipart/form-data">
            ...
            <div id="thumbInputs">
                ...
                <img  class="h-full w-full rounded-full object-cover object-center img-fluid" id="preview" alt="Current Thumbnail" class="mt-2" width="150">
                <div class="col-3 mb-3">
                    <div class="gallery_items column">
                        <button type="button" id="deleteButton" class="btn btn-danger mt-2"  style="display: none;" onclick="deleteImage()">Delete Image</button>
                    </div>
                </div>
            </div>
